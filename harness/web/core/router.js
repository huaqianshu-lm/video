export function parseRoute(hash = "") {
  ...
  if (normalized === "/batches/new") return { name: "batch-create", slug: null };
  if (normalized === "/batches") return { name: "batches", slug: null };
  if (normalized === "/remotion-tasks") return { name: "remotion-tasks", slug: null };
