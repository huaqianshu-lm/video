...
async function uploadSeriesCover() {
  ...
  try {
    ...
    const response = await fetch(`/api/series/${encodeURIComponent(series.id)}/cover`, {
      method: "PUT",
...
async function performRemotionTaskAction(action, id) {
  ...
  try {
    const response = await fetch(`/api/remotion-tasks/${encodeURIComponent(id)}/action`, {
      method: "POST",
      headers: { "Content-Type": "application/json" },
...
async function performBatchAction(action, id, slug = null) {
  try {
    const response = await fetch(`/api/batches/${encodeURIComponent(id)}/action`, {
      method: "POST",
      headers: { "Content-Type": "application/json" },
...
async function retryAgentJob(slug, id) {
  try {
    const response = await fetch(`/api/agent-jobs/${encodeURIComponent(id)}/action`, {
      method: "POST",
      headers: { "Content-Type": "application/json" },
...
async function readAgentJob(id) {
  const response = await fetch(`/api/agent-jobs/${encodeURIComponent(id)}`, { cache: "no-store" });
...
async function readRemotionTask(id) {
  const response = await fetch(`/api/remotion-tasks/${encodeURIComponent(id)}`, { cache: "no-store" });
  if (!response.ok) return null;
  const payload = await response.json();
